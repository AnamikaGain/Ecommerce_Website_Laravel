                    ...
                    <nav class="navbar navbar-default">
                        ...
                        <div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
                            <ul class="nav navbar-nav">
                                ...
                                <!-- Mega Menu -->
                              @include('front-end.includes.category')
                               <li class="dropdown">
                                   <a href="{{route('category-product')}}"class="dropdown-toggle" data-toggle="dropdown">Men <b class="caret"></b></a>
                   ...
                   <div class="cart box_1">
                       <a href="checkout.html">
                           <h3> <div class="total">
                               ...
                               <img src="{{ asset ('/') }}/front-end/{{ asset ('/') }}/front-end/images/bag.png" alt="" />
                           </h3>
                       </a>
