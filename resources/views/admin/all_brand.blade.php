				...
				<div class="box-content">
                 ...
                 @foreach( $all_brand_info as $v_brand)
					  <tbody>
						...
						<td class="center">
                            @if($v_brand->publication_status==1)
							<a class="btn btn-danger" href="{{URL::to('/unactive_brand/'.$v_brand->id)}}">
								<i class="halflings-icon white thumbs-down"></i>
							</a>
                            @else
                             <a class="btn btn-success" href="{{URL::to('/active_brand/'.$v_brand->id)}}">
							...
							<a class="btn btn-danger" href="{{URL::to('/delete-brand/'.$v_brand->id)}}" id="delete">
